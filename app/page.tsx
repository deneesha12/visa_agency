...
<div className="grid md:grid-cols-3 gap-6 mt-8">
  <Link href="/tourist-visa">
    <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition cursor-pointer">
      <h3 className="text-xl font-semibold text-blue-700 mb-2">Tourist Visa</h3>
      <p className="text-gray-600">Travel for leisure and explore the world with ease.</p>
    </div>
  </Link>

  <Link href="/business-visa">
    <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition cursor-pointer">
      <h3 className="text-xl font-semibold text-blue-700 mb-2">Business Visa</h3>
      <p className="text-gray-600">Attend meetings, conferences, and expand your business globally.</p>
    </div>
  </Link>

  <Link href="/student-visa">
    <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition cursor-pointer">
      <h3 className="text-xl font-semibold text-blue-700 mb-2">Student Visa</h3>
      <p className="text-gray-600">Achieve your academic goals with expert visa guidance.</p>
    </div>
  </Link>
</div>
...
<section
  ...
  style={{
    backgroundImage: "url('/hero1.jpg.jpg')", // ✅ Make sure this image is inside your public folder
    minHeight: "100vh",
    width: "100%",
  }}
>
  {/* Overlay (dark tint for better text visibility) */}
  ...
  <div className="relative z-10 px-4">
    ...
    <p className="text-gray-200 mb-8 max-w-2xl mx-auto">
      SKS Travels & Tourism helps applicants easily apply, upload documents,
      and track their visa status — all in one secure platform.
    </p>
    ...
    >
      ...
      <section id="services" className="py-20 bg-gray-50">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto px-6">
          ...
          <Link href="/tourist-visa">
            <div
              className="relative h-72 rounded-2xl shadow-md hover:shadow-xl transition-transform duration-300 hover:scale-[1.03] cursor-pointer bg-cover bg-center overflow-hidden"
              style={{
                backgroundImage: "url('/images/Tourist-Visa.jpg')",
              }}
            >
              <div className="absolute inset-0 bg-black/40"></div>
          ...
          <Link href="/business-visa">
            <div
              className="relative h-72 rounded-2xl shadow-md hover:shadow-xl transition-transform duration-300 hover:scale-[1.03] cursor-pointer bg-cover bg-center overflow-hidden"
              style={{
                backgroundImage: "url('/images/Business-Visa.jpg')",
              }}
            >
              <div className="absolute inset-0 bg-black/40"></div>
              <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
                ...
                <p className="text-sm max-w-xs">
                  Attend meetings, conferences, and expand your business
                  globally.
                </p>
              </div>
            </div>
          ...
          <Link href="/student-visa">
            <div
              className="relative h-72 rounded-2xl shadow-md hover:shadow-xl transition-transform duration-300 hover:scale-[1.03] cursor-pointer bg-cover bg-center overflow-hidden"
              style={{
                backgroundImage: "url('/images/Student-Visa.jpg')",
              }}
            >
              <div className="absolute inset-0 bg-black/40"></div>
              <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
