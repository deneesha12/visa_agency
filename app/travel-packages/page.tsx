      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 text-center text-white">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-blue-100">
            ...
            Thailand, Vietnam, Singapore, Dubai & more. Trusted by travelers
            since 2017!
          </p>
        </div>
      </section>
        ...
        <div className="lg:col-span-9">
          ...
          <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-8">
            {PACKAGES.map((p) => (
              ...
              >
                <Link href={`/travel-packages/${p.id}`} className="relative block h-48">
  <Image
    src={p.img}
    alt={p.title}
    fill
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex items-center gap-3 pt-3">
                    <Link
                      ...
                      className="flex-1 text-center px-4 py-2 text-sm rounded-md border border-gray-300 hover:bg-gray-100 font-medium text-gray-800 transition"
                    >
                      View Details
                    </Link>
                    <Link
                      href="/apply"
                      className="flex-1 text-center px-4 py-2 text-sm rounded-md bg-blue-600 text-white hover:bg-blue-700 font-medium transition"
                    >
                      Book Now
                    </Link>
                  </div>
